...
docstring.interpd.update(_bases_filename_parser=
"""parser : ['name' | 'number' | 'read' | mapping | callable]
    ...
    'name' : Use the measurement name given in the file name.
        ...
        IMPORTANT: The filename must look like the template above.
...
docstring.interpd.update(_bases_position_parser=
"""position_parser :
...
docstring.interpd.update(_bases_ID=
"""ID : hashable
    Collection ID""")

docstring.interpd.update(_bases_data_files=
"""datafiles : str | iterable
    A set of data files containing the measurements.""")

docstring.interpd.update(_bases_ID_kwargs=
"""ID_kwargs: dict
