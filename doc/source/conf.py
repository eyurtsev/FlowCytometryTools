# -*- coding: utf-8 -*-
#
# FlowCytometryTools documentation build configuration file, created by
# sphinx-quickstart on Sat Oct 12 16:30:49 2013.
#
...
# Takes documentation both from class doc and from __init__
...
latex_documents = [
  ('index', 'FlowCytometryTools.tex', u'FlowCytometryTools Documentation',
   u'Jonathan Friedman & Eugene Yurtsev', 'manual'),
]
...
man_pages = [
    ('index', 'FlowCytometryTools', u'FlowCytometryTools Documentation',
     [u'Jonathan Friedman & Eugene Yurtsev'], 1)
]
...
texinfo_documents = [
  ('index', 'FlowCytometryTools', u'FlowCytometryTools Documentation',
   u'Jonathan Friedman and Eugene Yurtsev', 'FlowCytometryTools', 'One line description of project.',
   'Miscellaneous'),
]
